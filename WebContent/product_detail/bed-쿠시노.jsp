...
<script>
	function img_change(img_id){
		...
		if(name =="../images/쿠시노_detail.jpg" ){
			document.getElementById("change").src ="../images/쿠시노_detail.jpg";
		}else if (name == "../images/쿠시노2_detail.jpg"){
	...
	<div class="product_detail">
		<section class="section1" id="section1_pd">
			<aside class="product_img">
				<div class="productmain_img" id="productmain_img">
					<img src = "../images/쿠시노_detail.jpg" id="change" >
		<!--돋보기 	<a href ="#"><img src = "http://localhost:9000/sist_project_2/images/magnify_grey.png"></a> -->
				...
				<div class="productmini_img" id="productmini_img">
					<img src = "../images/쿠시노_detail.jpg" id ="change1" onclick = "img_change('change1')">
					<img src = "../images/쿠시노2_detail.jpg" id ="change2" onclick = "img_change('change2')">
					<hr>
				</div>
			</aside>
...
<!-- 제품코드만 고치기! -->	배송방법 <span>설치배송</span> 제품코드<span>HB722501</span>
					</li>
					
					<li>
<!--고치기-->				<select name="product_colors" id="product_colors">
					  		<option value="선택">[필수] 색상을 선택해주세요</option>
					  		<option value="A4810">A4810 1,009,000원</option>
					  	</select>
				  	</li>
				  	<hr>
