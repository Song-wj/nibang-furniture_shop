...
<script>
	function img_change(img_id){
		...
		if(name =="../images/c루오바1.jpg" ){
			document.getElementById("change").src ="../images/c루오바1.jpg";
		}else if (name == "../images/c루오바2.jpg"){
			document.getElementById("change").src ="../images/c루오바2.jpg";
		}
	}
</script>
<body>
	...
	<div class="product_detail">
		<section class="section1" id="section1_pd">
			<aside class="product_img">
				<div class="productmain_img" id="productmain_img">
					<img src = "../images/c루오바1.jpg" id="change" >
		<!--돋보기 	<a href ="#"><img src = "http://localhost:9000/sist_project_2/images/magnify_grey.png"></a> -->
				...
				<div class="productmini_img" id="productmini_img">
					<img src = "../images/c루오바1.jpg" id ="change1" onclick = "img_change('change1')">
					<img src = "../images/c루오바2.jpg" id ="change2" onclick = "img_change('change2')">
					<hr>
				</div>
			</aside>
			<div class="product_payInfo" id="product_payInfo">
				<ul>
<!--제품명 고치기--><li class="pname">루오바</li>
<!--고치기-->			<li class="pexplain">코너(가죽)</li>
<!--고치기-->			<li class="pprice">2,540,000원</li> 				
					<hr>					
					<li class="pcode">
						배송기간 <span>약 10일</span> 배송비<span>무료배송</span>
<!-- 제품코드만 고치기! -->	배송방법 <span>설치배송</span> 제품코드<span>HCS783C</span>
					</li>
