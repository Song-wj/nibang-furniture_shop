...
<script>
	function img_change(img_id){
		...
		if(name =="../images/미엘1.jpg" ){
			document.getElementById("change").src ="../images/미엘_메인.jpg";
		}else if (name == "../images/미엘2.jpg"){
			document.getElementById("change").src ="../images/미엘2.jpg";
		}else{
			document.getElementById("change").src ="../images/미엘3.jpg";
		}
	}
	...
	<div class="product_detail">
		<section class="section1" id="section1_pd">
			<aside class="product_img">
				<div class="productmain_img" id="productmain_img">
					<img src = "../images/미엘_메인.jpg" id="change" >
		<!--돋보기 	<a href ="#"><img src = "http://localhost:9000/sist_project_2/images/magnify_grey.png"></a> -->
				...
				<div class="productmini_img" id="productmini_img">
					<img src = "../images/미엘1.jpg" id ="change1" onclick = "img_change('change1')">
					<img src = "../images/미엘2.jpg" id ="change2" onclick = "img_change('change2')">
					<img src = "../images/미엘3.jpg" id ="change3" onclick = "img_change('change3')">
					<hr>
				</div>
			</aside>
			<div class="product_payInfo" id="product_payInfo">
				<ul>
<!--제품명 고치기--><li class="pname">미엘</li>
<!--고치기-->			<li class="pexplain">5단 서랍장 600폭</li>
<!--고치기-->			<li class="pprice">349,000원</li> 				
					<hr>					
					<li class="pcode">
						배송기간 <span>약 10일</span> 배송비<span>무료배송</span>
<!-- 제품코드만 고치기! -->	배송방법 <span>설치배송</span> 제품코드<span>HP900651R</span>
					</li>
					
					<li>
<!--고치기-->				<select name="product_colors" id="product_colors">
					  		<option value="선택">[필수] 색상을 선택해주세요</option>
					  		<option value="CGYA">FIVGYM 349,000원</option>
					  		<option value="GYA">NCCBGM 349,000원</option>
					  	</select>
				  	</li>
				  	<hr>
...
랜덤			<a href=""><img src=""></a>
		...
		<section class="section3_product_img" id="section3_product_img">
			<div class="product_closet_img" id="product_closet_img">
				<img src="http://localhost:9000/sist_project_2/images/미엘4.jpg">
				<p class="explain_title">미엘 600폭 5단 서랍장</p>
				<p>
					투톤 컬러로 세련된 느낌을 주는 미엘 서랍장입니다.  <br>
					서랍장과 오픈된 상부 수납공간이 있어 다양한 수납이 가능합니다. 
				</p>
				<hr>
				<p class="explain_title">NEUTRAL STYLE RENEWAL</p>
				<p>
					학생방 ‘이타카네오’와 침실 ‘미엘갤러리(미엘)’의 우드 컬러 CC가 NCC색상으로 리뉴얼되었습니다.<br>
					편안함을 주는 뉴트럴 스타일로 보다 업그레이드된 공간을 제안합니다. 
				</p>
