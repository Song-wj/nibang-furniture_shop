...
<script>
	function img_change(img_id){
		...
		if(name =="../images/아르지안1.jpg"){
			document.getElementById("change").src ="../images/아르지안1.jpg";
		}else if(name =="../images/아르지안2.jpg"){
			document.getElementById("change").src ="../images/아르지안2.jpg";
		}
	}
	...
	<div class="product_detail">
		<section class="section1" id="section1_pd">
			<aside class="product_img">
				<div class="productmain_img" id="productmain_img">
					<img src = "../images/아르지안_메인.jpg" id="change" >
		<!--돋보기 	<a href ="#"><img src = "http://localhost:9000/sist_project_2/images/magnify_grey.png"></a> -->
				...
				<div class="productmini_img" id="productmini_img">
					<img src = "../images/아르지안1.jpg" id ="change1" onclick = "img_change('change1')">
					<img src = "../images/아르지안2.jpg" id ="change2" onclick = "img_change('change2')">
					<hr>
				</div>
			</aside>
			<div class="product_payInfo" id="product_payInfo">
				<ul>
<!--제품명 고치기--><li class="pname">아르지안</li>
<!--고치기-->			<li class="pexplain">3단 와이드체스트 1200폭</li>
<!--고치기-->			<li class="pprice">541,000원</li> 				
					<hr>					
					<li class="pcode">
						배송기간 <span>약 10일</span> 배송비<span>무료배송</span>
<!-- 제품코드만 고치기! -->	배송방법 <span>설치배송</span> 제품코드<span>HP311231</span>
					</li>
					
					<li>
<!--고치기-->				<select name="product_colors" id="product_colors">
					  		<option value="선택">[필수] 색상을 선택해주세요</option>
					  		<option value="CGYA">LDGYM 541,000원</option>
					  	</select>
				  	</li>
				  	<hr>
...
랜덤			<a href=""><img src=""></a>
		...
		<section class="section3_product_img" id="section3_product_img">
			<div class="product_closet_img" id="product_closet_img">
				<img src="http://localhost:9000/sist_project_2/images/아르지안3.jpg">
				<p class="explain_title">아르지안 3단 와이드체스트 1200폭</p>
				<p>
					모던하게 절제된 디자인과 깊은 수납공간으로 구성된 아르지안 서랍장입니다. <br>
					포인트 컬러의 매립형 손잡이와 깔끔한 유리 상판으로 고급스러우면서도 심플한 멋을 살려줍니다.
				</p>
