...
<script>
	function img_change(img_id){
		...
		if(name =="../images/table_detail_타이디.jpg" ){
			document.getElementById("change").src ="../images/table_detail_타이디.jpg";
		}else if (name == "../images/table_detail_타이디2.jpg"){
			document.getElementById("change").src ="../images/table_detail_타이디2.jpg";
		}
	}
</script>
<body>
	...
	<div class="product_detail">
		<section class="section1" id="section1_pd">
			<aside class="product_img">
				<div class="productmain_img" id="productmain_img">
					<img src = "../images/table_detail_타이디.jpg" id="change" >
		<!--돋보기 	<a href ="#"><img src = "http://localhost:9000/sist_project_2/images/magnify_grey.png"></a> -->
				...
				<div class="productmini_img" id="productmini_img">
					<img src = "../images/table_detail_타이디.jpg" id ="change1" onclick = "img_change('change1')">
					<img src = "../images/table_detail_타이디2.jpg" id ="change2" onclick = "img_change('change2')">
					<hr>
				</div>
			</aside>
			<div class="product_payInfo" id="product_payInfo">
				<ul>
<!--제품명 고치기--><li class="pname">타이디</li>
<!--고치기-->			<li class="pexplain">수납형 식탁 1400폭</li>
<!--고치기-->			<li class="pprice">420,000원</li> 				
					<hr>					
					<li class="pcode">
						배송기간 <span>약 10일</span> 배송비<span>무료배송</span>
<!-- 제품코드만 고치기! -->	배송방법 <span>설치배송</span> 제품코드<span>HT60T14EL</span>
					</li>
					
					<li>
<!--고치기-->				<select name="product_colors" id="product_colors">
					  		<option value="선택">[필수] 색상을 선택해주세요</option>
					  		<option value="CGYA">LD 420,000원</option>
					  	</select>
				  	</li>
				  	<hr>
