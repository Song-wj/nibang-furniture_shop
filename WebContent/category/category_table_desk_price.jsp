<%@ page language="java" contentType="text/html; charset=UTF-8"
  ...
  <%
  		...
  		ArrayList<productVO> list = dao.priceTableList();
		...
		<section class="section1" id="section1_category_bed">
			<div>
				...
				<div class="category_sort">
					<a href="category_table_desk.jsp">인기순</a>
					<a href="#">신상품순</a>
				...
				<% for(productVO vo : list){ %>
					...
					<li class="product_list">
						<a href="http://localhost:9000/sist_project_2/product_detail/table_<%=vo.getPname() %>.jsp">
