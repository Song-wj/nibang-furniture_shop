...
<style>
	...
	/* ----- hover image ----- */
	#section1_category_bed ul li.product_list p.product_img a.product1_hover {
		display: inline-block;
		width: 274px;
		height: 274px;
		margin-bottom: -12px;
	...
	#section1_category_bed ul li.product_list p.product_img a.product1_hover:hover {
		background-image: url('http://localhost:9000/sist_project_2/images/쿠시노_저상형(SS)-480000.jpg');
	}
	
	#section1_category_bed ul li.product_list p.product_img a.product2_hover {
		display: inline-block;
		width: 274px;
		height: 274px;
		margin-bottom: -12px;
	...
	#section1_category_bed ul li.product_list p.product_img a.product2_hover:hover {
