...
<%
	...
	int pageTotal = dao.getListCountMember();
	...
	int dbCount = dao.getListCountMember() ; // DB연동 후 전체로우수 출력
	int reqPage = 1;//요청페이지
	...
	ArrayList<faqVO> list = dao.getFAQListMember(start, end);
	dao.nibangViews(fid);
%>
<!DOCTYPE html>
<html>
 		...
 		<script>
	 		$(document).ready(function(){
	 			...
	 			jQuery("#ampaginationsm").on('am.pagination.change', function(e){
	 				$(location).attr('href','http://localhost:9000/sist_project_2/customer_service/FAQ_member.jsp?id=<%=mid%>&rpage=' + e.page);
