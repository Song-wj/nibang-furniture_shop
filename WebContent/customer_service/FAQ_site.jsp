...
<%
	...
	int dbCount = dao.getListCountSite() ; // DB연동 후 전체로우수 출력
	int reqPage = 1;//요청페이지
	...
	ArrayList<faqVO> list = dao.getFAQListSite(start, end);
	dao.nibangViews(fid);
%>
<!DOCTYPE html>
<html>
 		...
 		<script>
	 		$(document).ready(function(){
	 			...
	 			jQuery("#ampaginationsm").on('am.pagination.change', function(e){
	 				$(location).attr('href','http://localhost:9000/sist_project_2/customer_service/FAQ_site.jsp?id=<%=mid%>&rpage=' + e.page);
